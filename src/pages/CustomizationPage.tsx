      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden bg-[#050508]">
        ...
        <div className="absolute left-6 md:left-12 top-1/2 -translate-y-1/2 h-48 md:h-64 w-[1px] bg-white/10 z-50 hidden md:block">
          <motion.div 
            ...
            className="w-full h-full bg-[#b90014] shadow-[0_0_15px_#b90014]"
          />
          ...
          <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-[10px] font-black uppercase tracking-widest text-[#b90014]">Lab</div>
        </div>
        ...
        <div className="relative h-full w-full flex items-center justify-center px-6">
          ...
          >
            <h1 className="text-5xl md:text-9xl font-black uppercase italic tracking-tighter leading-none">
              THE <span className="text-[#b90014]">FORGE</span>
            </h1>
            ...
            >
              <ArrowDown className="text-[#b90014]" size={24} />
            </motion.div>
          </motion.div>
          ...
          >
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl md:rounded-3xl bg-[#b90014]/10 border border-[#b90014]/20 flex items-center justify-center mb-2 md:mb-4">
              <Bolt size={32} className="text-[#b90014] md:hidden" />
              <Bolt size={40} className="text-[#b90014] hidden md:block" />
            </div>
            <span className="text-[#b90014] text-[10px] md:text-xs font-black uppercase tracking-[0.4em] md:tracking-[0.6em]">Step 01</span>
          ...
          >
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl md:rounded-3xl bg-[#b90014]/10 border border-[#b90014]/20 flex items-center justify-center mb-2 md:mb-4">
              <Palette size={32} className="text-[#b90014] md:hidden" />
              <Palette size={40} className="text-[#b90014] hidden md:block" />
            </div>
            <span className="text-[#b90014] text-[10px] md:text-xs font-black uppercase tracking-[0.4em] md:tracking-[0.6em]">Step 02</span>
            <h2 className="text-4xl md:text-7xl font-black uppercase italic tracking-tighter leading-none">
          ...
          >
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl md:rounded-3xl bg-[#b90014]/10 border border-[#b90014]/20 flex items-center justify-center mb-2 md:mb-4">
              <Shield size={32} className="text-[#b90014] md:hidden" />
              <Shield size={40} className="text-[#b90014] hidden md:block" />
            </div>
            <span className="text-[#b90014] text-[10px] md:text-xs font-black uppercase tracking-[0.4em] md:tracking-[0.6em]">Step 03</span>
            <h2 className="text-4xl md:text-7xl font-black uppercase italic tracking-tighter leading-none">
          ...
          >
            <div className="w-full max-w-4xl p-8 md:p-12 bg-[#0D0D14] rounded-2xl md:rounded-[32px] border border-white/5 shadow-[0_0_100px_rgba(0,0,0,1)] relative overflow-hidden text-center space-y-8 md:space-y-12">
              <div className="absolute inset-0 bg-gradient-to-b from-[#b90014]/10 to-transparent pointer-events-none" />
              
              <div className="relative z-10 space-y-4 md:space-y-6">
                <div className="flex justify-center">
                  <div className="w-16 h-16 md:w-24 md:h-24 rounded-full bg-[#b90014] flex items-center justify-center shadow-[0_0_50px_rgba(185,0,20,0.4)]">
                ...
                <h2 className="text-3xl md:text-6xl font-black uppercase italic tracking-tighter">
                  SYSTEM <span className="text-[#b90014]">READY</span>
                </h2>
                ...
                <div className="pt-4 md:pt-8">
                  <Link 
                    to="/custom-lab"
                    className="inline-flex items-center gap-3 md:gap-4 px-8 md:px-12 py-4 md:py-6 bg-[#b90014] text-white rounded-xl md:rounded-2xl font-black uppercase tracking-[0.2em] text-xs md:text-sm hover:bg-white hover:text-black transition-all shadow-[0_0_40px_rgba(185,0,20,0.3)] group"
                  >
              ...
              {/* Decorative Elements */}
              <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#b90014] to-transparent opacity-50" />
            </div>
          </motion.div>

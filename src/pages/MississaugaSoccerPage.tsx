  ...
  return (
    <>
      ...
      <div className="bg-white text-zinc-900">
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-2xl border border-zinc-200 shadow-xl">
                <img
                  ...
                  alt="Soccer store in Mississauga â€” cleats, jerseys and custom kits"
        ...
        {/* â”€â”€ SERVING THE COMMUNITY â”€â”€ */}
        <section className="py-20 md:py-28 bg-zinc-50">
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="mb-14 max-w-3xl">
              <p className="text-[var(--primary-color)] text-xs font-black uppercase tracking-widest mb-3">Serving the Community</p>
              <h2 className="text-4xl md:text-5xl font-black uppercase italic tracking-tighter leading-none mb-6">
                ...
                <span className="text-[var(--primary-color)]">Local Clubs and Players</span>
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-zinc-500 text-lg leading-relaxed mb-8">
                  ...
                  and support local â€” come check out the wall of elite cleats and get your gear
              ...
              <div className="space-y-4">
                {[
                  'In-stock Nike, Adidas & Puma footwear â€” try before you buy',

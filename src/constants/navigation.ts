...
export const DEFAULT_NAV: NavMenu[] = [
  {
    label: 'FOOTWEAR',
    path: '/footwear',
    submenus: [
      ...
      },
      {
        ...
        items: [
          { 
            label: 'Firm Ground', 
            path: '/footwear/firm-ground',
            logo: 'https://images.unsplash.com/photo-1511886929837-354d827aae26?auto=format&fit=crop&q=80&w=200&h=200' 
          },
          { 
            label: 'Artificial Grass', 
            path: '/footwear/artificial-grass',
            logo: 'https://images.unsplash.com/photo-1551958219-acbc608c6377?auto=format&fit=crop&q=80&w=200&h=200'
          },
          { 
            label: 'Turf', 
            path: '/footwear/turf',
            logo: 'https://images.unsplash.com/photo-1431324155629-1a6eda1eed2e?auto=format&fit=crop&q=80&w=200&h=200'
          },
          { 
            label: 'Indoor / Futsal', 
            path: '/footwear/indoor-futsal',
            logo: 'https://images.unsplash.com/photo-1518605336396-6a727c5c044f?auto=format&fit=crop&q=80&w=200&h=200'
          },
        ]
      },
      {
        ...
        items: [
          { 
            ...
            path: '/footwear/nike/mercurial',
            logo: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=200&h=200'
          },
          { 
            label: 'Nike Phantom', 
            path: '/footwear/nike/phantom',
            logo: 'https://images.unsplash.com/photo-1514989940723-e8e51635b782?auto=format&fit=crop&q=80&w=200&h=200'
          },
          { 
            label: 'Nike Tiempo', 
            path: '/footwear/nike/tiempo',
            logo: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&q=80&w=200&h=200'
          },
          { 
            label: 'adidas F50', 
            path: '/footwear/adidas/f50',
            logo: 'https://images.unsplash.com/photo-1587563871167-1ee9c731aefb?auto=format&fit=crop&q=80&w=200&h=200'
          },
          { 
            label: 'adidas Predator', 
            path: '/footwear/adidas/predator',
            logo: 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?auto=format&fit=crop&q=80&w=200&h=200'
          },
          { 
            label: 'adidas Copa', 
            path: '/footwear/adidas/copa',
            logo: 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?auto=format&fit=crop&q=80&w=200&h=200'
          },
          { 
            label: 'PUMA Future', 
            path: '/footwear/puma/future',
            logo: 'https://images.unsplash.com/photo-1511556532299-8f662fc26c06?auto=format&fit=crop&q=80&w=200&h=200'
          },
          { 
            label: 'PUMA Ultra', 
            path: '/footwear/puma/ultra',
            logo: 'https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?auto=format&fit=crop&q=80&w=200&h=200'
          },
        ]
      },
      {

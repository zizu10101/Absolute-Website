      ...
      <div className="flex flex-col h-full bg-zinc-50">
        ...
        <div className="p-5 border-t bg-white flex gap-3">
          ...
          <button
            ...
            disabled={isSaving}
            className="flex-1 py-3 bg-zinc-950 text-white rounded-xl text-[11px] font-black uppercase hover:bg-[var(--primary-color)] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
      ...
      <div className="bg-white border-b border-zinc-200 p-5 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-zinc-950 text-white rounded-lg text-[10px] font-black uppercase hover:bg-[var(--primary-color)] transition-colors"
          >
